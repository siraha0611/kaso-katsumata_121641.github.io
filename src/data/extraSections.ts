...
export const commissionCases = [
  {
    title: "凛野 翠",
    description: "ラフ、線画、完成までの依頼制作工程。",
    images: ["/assets/commission-rinno-rough.jpg", "/assets/commission-rinno-line.jpg", "/assets/commission-rinno-finish.png"]
  },
  {
    title: "天野 明人",
    description: "夢ティHO4立ち絵。ラフから完成まで。",
    images: ["/assets/commission-amano-rough.jpg", "/assets/commission-amano-finish.png", "/assets/commission-amano.png"]
  },
  {
    title: "チリ",
    description: "依頼立ち絵。ラフ、完成、報告用画像。",
    images: ["/assets/commission-chiri-rough.jpg", "/assets/commission-chiri-finish.jpg", "/assets/commission-chiri.png"]
  }
];
