...
export const axes: Axis[] = [
  {
    ...
    body: [
      ...
      "2025年10月から制作している『夢語りはティータイムのあとで』では、シナリオ本文だけでなく、ロゴ・NPC・MAP・セッション素材までを“ひとつの体験”として設計しています。12万文字を超える長編をBOOTHで頒布しながら、物理版をゲームマーケットに向けて制作中。丁寧さを忘れたら面白味が消える――細部の積み重ねが、卓の説得力になると信じています。"
    ],
    works: [
  ...
  },
  {
    ...
    body: [
      "大学ではアニメーションを学び、卒業制作『-CORE-』を企画から作画・編集まで担って完成させ、卒業制作展でアニメ制作ゼミ最優秀賞をいただきました。キャラクターが画面のなかで動き出す、その一点の喜びがすべての原点です。",
